<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecificGeneralDiscussionForumPageLoggedOut.aspx.cs" Inherits="ShoppingCart.SpecificGeneralDiscussionForumPageLoggedOut" %>
            ...
            <div style="width: 1246px">
                ...
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">iPhone 6plus is so big! It is somewhat like Samsung Note 3 but just in iOS version. Apple finally managed release one product of the same size as Samsung phone.<br />
                            However, the size, is too big for us to hold it in 1 hand. I feel that a smaller phone would be better for an Apple phone. Though it is an achievement or rather a surpirse to see a change in apple products, the changes are kind of big too. Oh well, it would be better for Apple to remain the size of a small phone =D <br />
                            <br />
                            <br />
                        </td>
                    </tr>
