<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecificGeneralDiscussionForumPageLoggedIn.aspx.cs" Inherits="ShoppingCart.SpecificGeneralDiscussionForumPageLoggedIn" %>
            ...
            <div style="width: 1244px">
                ...
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td colspan="3" style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">iPhone 6plus is so big! It is somewhat like Samsung Note 3 but just in iOS version. Apple finally managed release one product of the same size as Samsung phone.<br />
                            However, the size, is too big for us to hold it in 1 hand. I feel that a smaller phone would be better for an Apple phone. Though it is an achievement or rather a surpirse to see a change in apple products, the changes are kind of big too. Oh well, it would be better for Apple to remain the size of a small phone =D
                            <br />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style26" style="border: medium solid #369B91; font-family: gungsuh; text-align: center; color: #FFFFFF;">
                            <asp:HyperLink ID="HypID0001Comment" runat="server" ForeColor="White">Comment</asp:HyperLink>
                        &nbsp; </td>
                        <td class="auto-style26" style="border: medium solid #369B91; font-family: gungsuh; text-align: center; color: #FFFFFF;">
                            <asp:HyperLink ID="HypID0001Del0" runat="server" ForeColor="White">Delete</asp:HyperLink>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div>
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td colspan="3" style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">Definitely agree to the above comment. iPhone 6plus is very very big. There is no difference in the size between Note 3 and iPhone 6 plus except for the iOS. The fingerprint security system on iPhone 6 amazes me too as it&#39;s a cool thing to have that as a security features in iOS. However, this could be found in iPhone 6 so, it makes no difference.&nbsp;
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style26" style="border: medium solid #369B91; font-family: gungsuh; text-align: center; color: #FFFFFF;">
                            <asp:HyperLink ID="HypID0001Comment0" runat="server" ForeColor="White">Comment</asp:HyperLink>
                        &nbsp; </td>
                        <td class="auto-style36" style="border: medium solid #369B91; font-family: gungsuh; text-align: center; color: #FFFFFF;">
                            <asp:HyperLink ID="HypID0001Del1" runat="server" ForeColor="White">Delete</asp:HyperLink>
                        </td>
                    </tr>
                </table>
            </div>
