<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecificAnnouncementForumPageAdminLoggedIn.aspx.cs" Inherits="ShoppingCart.SpecificAnnouncementForumPageAdminLoggedIn" %>
            ...
            <div style="width: 1244px">
                ...
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td colspan="3" style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">To all SMS valued customers,<br />
                            <br />
                    ...
                    <tr>
                        ...
                        <td class="auto-style26" style="border: medium solid #369B91; font-family: gungsuh; text-align: center; color: #FFFFFF;">
                            <asp:HyperLink ID="HypIDA0001Comment" runat="server" ForeColor="White">Comment</asp:HyperLink>
                        &nbsp; </td>
                        <td class="auto-style26" style="border: medium solid #369B91; font-family: gungsuh; text-align: center; color: #FFFFFF;">
                            <asp:HyperLink ID="HypIDA0001Del0" runat="server" ForeColor="White">Delete</asp:HyperLink>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div>
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td colspan="3" style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">Woohoo ! Yay, thats cool ! Finally what I&#39;m waiting for has arrived! =D<br />
                            <br />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style26" style="border: medium solid #369B91; font-family: gungsuh; text-align: center; color: #FFFFFF;">
                            <asp:HyperLink ID="HypIDA0001Comment0" runat="server" ForeColor="White">Comment</asp:HyperLink>
                        &nbsp; </td>
                        <td class="auto-style26" style="border: medium solid #369B91; font-family: gungsuh; text-align: center; color: #FFFFFF;">
                            <asp:HyperLink ID="HypIDA0001Del1" runat="server" ForeColor="White">Delete</asp:HyperLink>
                        </td>
                    </tr>
                </table>
            </div>
