<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnnouncementForumPageAdminLoggedIn.aspx.cs" Inherits="ShoppingCart.AnnouncementForumPageAdminLoggedIn" %>
                ...
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        <td style="border: medium solid #369B91; background-color: #435355; font-family: gungsuh; text-align: left; vertical-align: top; color: #FFFFFF;" class="auto-style30" draggable="true" rowspan="7">
                            ...
                            Username: <asp:Label ID="lblUsername" runat="server" Font-Italic="True">Admin</asp:Label>
                        </td>
