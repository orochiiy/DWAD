<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecificFeedbackForumPageLoggedOut.aspx.cs" Inherits="ShoppingCart.SpecificFeedbackForumPageLoggedOut" %>
            ...
            <div style="width: 1246px">
                ...
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">Defects were found on my iphone 6 when i received it from the online store.
                            <br />
        ...
        <div>
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">Hi Mr. Tan, not to worry, you just have to bring your receipt and the iPhone along to any of our retail outlet shop and our staffs will attend to this matter.<br />
                            <br />
                        </td>
                    </tr>
                    <tr>
