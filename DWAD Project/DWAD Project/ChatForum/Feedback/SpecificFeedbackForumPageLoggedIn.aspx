<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecificFeedbackForumPageLoggedIn.aspx.cs" Inherits="ShoppingCart.SpecificFeedbackForumPageLoggedIn" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div>
            ...
            <div style="font-family: comfortaa; color: #FFFFFF; text-align: left; width: 1240px; background-color: #369B91; height: 22px; font-size: large;">
                Title: Defects found in product when received!</div>
            <div style="width: 1244px">
                ...
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td colspan="3" style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">Defects were found on my iphone 6 when i received it from the online store.
                            <br />
                            There were cracks on the edges of the phone and the screen has some sort of cracks.<br />
                            Is there anything I can do?<br />
                            <br />
                            I&#39;m Mr. Tan<br />
                            You can contact me @81234567 or email me at tanahkao@gmail.com <br />
                            <br />
                        </td>
                    </tr>
                    <tr>
        ...
        <div>
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td colspan="3" style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">Hi Mr. Tan, not to worry, you just have to bring your receipt and the iPhone along to any of our retail outlet shop and our staffs will attend to this matter.<br />
                        </td>
                    </tr>
                    <tr>
