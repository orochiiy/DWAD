<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecificQnAForumPageLoggedOut.aspx.cs" Inherits="ShoppingCart.SpecificQnAForumPageLoggedOut" %>
            ...
            <div style="width: 1246px">
                ...
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">Up till now, i still do not know if iPhone 6 plus is good. Is it really good?<br />
                            <br />
                            <br />
                        </td>
                    </tr>
        ...
        <div>
                <table style="width:100%; height: 293px; margin-left: 2px; margin-top: 0px;" dir="ltr" draggable="true">
                    <tr>
                        ...
                        <td style="border: medium solid #369B91; background-color: #435355; font-family: comfortaa; text-align: left; color: #FFFFFF; vertical-align: top;" draggable="true" class="auto-style34">Ofcuz good. Be it battery capacity, size or even processor, all of them beats the other iPhone. iPhone 6 plus has the smallest battery capacity, which means charging time would be faster than any other phone. It has the biggest size among the other Apple products which makes the screen looks bigger and able to fit more objects in the screen. It has the latest processor which means that it is currently the fastest iPhone product u can ever find amongst the other iPhone.
                            <br />
